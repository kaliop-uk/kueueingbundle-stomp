...
activemq)
    ...
    sudo sed -i 's/<transportConnectors>/<transportConnectors><transportConnector name="stomp" uri="stomp:\/\/0.0.0.0:61613"\/>/g' /etc/activemq/instances-available/main/rabbitmq.xml
